...
Canonical upstream: `https://github.com/executiveusa/vibe-engineering/blob/main/skills/visual-independence-governor/SKILL.md`

This local copy exists so Synthia can operate when upstream is unavailable. Refresh deliberately; do not silently fork the method.
